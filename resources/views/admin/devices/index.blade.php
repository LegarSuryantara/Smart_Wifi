<x-app-layout>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="overflow-x-auto">
                ...
                <div x-data="{ isOpen: false, qrCode: '', loading: false }">
                    ...
                    @include('admin.devices.partials.modal-qr-code')
                </div>
            </div>
        </div>
    </div>
    ...
    @include('admin.devices.partials.modal-device-details')
    @include('admin.devices.partials.modal-confirmation-delete')
    @include('admin.devices.partials.modal-confirmation-disconnect')
    @include('admin.devices.partials.modal-otp-delete')
    @include('admin.devices.partials.modal-send-message')
    @include('admin.devices.partials.script')
</x-app-layout>