                  ...
                  <li class="nav-item">
                    ...
                    @if (Route::has('login'))
                        <nav class="flex items-center justify-end gap-4">
                            @auth
                                <a
                                    href="{{ auth()->user()->hasAnyPermission('admin-access') ? route('admin.index') : route('user.index') }}"
                            ...
                            @else
                                <a  type="button"
                                    href="{{ route('login') }}"
                                    class="btn btn-primary inline-block px-5 py-1.5 dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-sm leading-normal"
                                >
                                    Log in
                                </a>
