...
class DeviceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.devices.index', compact('devices', 'page_title'));
    }

    public function create()
    {
        return view('admin.devices.create'); // Menampilkan halaman form penambahan device
    }
    ...
    public function show($id)
    {
        ...
        if ($response['status']) {
            return response()->json([
                'html' => view('amdin.devices.partials.show', compact('device', 'response'))->render(),
            ]);
        }
